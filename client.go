...
type Options struct {
	...
	Client *http.Client // Custom Client for outgoing http.Client, if nil default will be used
}
...
func setCookie(w http.ResponseWriter, r *http.Request, ticket string) {
...
func getCookie(w http.ResponseWriter, r *http.Request) *http.Cookie {
	...
	if err != nil {
		if glog.V(2) {
			glog.Infof("No cookie found : %v", sessionCookieName)
		}
		return &http.Cookie{}
	}
